...
def get_oa_list(search_csv, term_list=["bone", "musc"]):
    ...
    oa_file_list_concat = oa_file_list_search
...
if __name__ == "__main__":
    ...
    if args.cmd == "filter":
        ...
        oa_file_list_final = get_oa_list(search_csv, term_list=["bone", "musc"])
